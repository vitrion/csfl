...
The project structure is based on the Microsoft Visual Studio 2013. The CSFL tool has been designed as an Object-Oriented C++11 implementation with CUDA 7.5. However it can also be imported in a NVIDIA Nsight Eclipse project. Also, it has been tested in the following GPUs: GTX650 Ti and Tesla K40C.
