...
3.  Register in our site and download the CSFL v1.1: www.onedrive.com. You will be downloading a ZIP file that you will have to unzip.
4.  Uncompress the downloaded RAR file (CSFL-v1_1.zip) and copy the resulting files to the directory of your preference. For example, in Windows create a directory in C: called fuzzy, i.e. C:\fuzzy; in Linux create a directory in /home/user/fuzzy/.
